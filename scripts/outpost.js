const outpost = extend(StorageBlock, "0c-1-01-outpost", {});

outpost.buildType = () =>
  extend(StorageBlock.StorageBuild, outpost, {
    displayReact(table) {
    ...
    removeStack(item, amount) {
      ...
      if (core && team == defaultTeam && state.isCampaign())
